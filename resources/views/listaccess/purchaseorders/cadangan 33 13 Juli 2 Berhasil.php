...
<script type="text/javascript">
    ...
    $("#smbtn").submit(function(e)
    {
        ...
        // if (typeof id !== 'undefined') // versi Pak Heri
        if(id != '') // versi produk
    ...
    //     var table4 = document.querySelector("#listProdukTable tbody");
    //     table4.innerHTML = "";
    //     // var url = "{{ asset('/api/purchaseorders/edit') }}/" + idx;
    //     // // var url = "{{ asset('/api/purchaseorders/updatedata') }}/" + idx;
    ...
    //                 htmlinput += '<tr class="" id="row-'+item[6]+'">\
    //                 <td class="sorting_1">'+item[0]+'</td>\
    //                 <td>'+item[1]+'</td>\
    //                 <td class=" dt-body-center">\
    //                     <div class="form-group row">\
    //                         <div class="col-xs-2"><input type="number" value="'+item[3]+'" name="jumlah_produk[\'id\']['+item[6]+']" id="jumlah_produk-'+item[6]+'" class="form-group form-control jumlah_produk"></div>\
    //                     </div>\
    //                 </td>\
    //                 <td class="  dt-body-center">\
    //                     <div class="form-group row">\
    //                         <div class="col-xs-2"><input type="number" value="'+item[4]+'" name="barang_bagus[\'id\']['+item[6]+']" id="barang_bagus-'+item[6]+'" class="form-group form-control barang_bagus"></div>\
    //                     </div>\
    //                 </td>\
    //                 <td class="  dt-body-center">\
    //                     <div class="form-group row">\
    //                         <div class="col-xs-2"><input type="number" value="'+item[5]+'" name="barang_jelek[\'id\']['+item[6]+']" id="barang_jelek-'+item[6]+'" class="form-group form-control barang_jelek"></div>\
    //                     </div>\
    //                 </td>\
    //                 <td class="  dt-body-center">\
    //                     <span class="btn btn-danger deletee btn-sm" onclick="kurangininput('+item[6]+')">\
    //                         <i class="fa-solid fa-trash-can"></i>\
    //                     </span>\
    //                 </td>\
    //                 </tr>';
    ...
    $("#editvbtn").click(function()
    {
        ...
        var urlGetDataById = "{{ asset('/api/purchaseorders/detail/') }}"+'/'+idx;
        ...
        $.ajax({
            ...
            success: function(response)
            {
                ...
                $.each(data, function(key, item) {
                    // console.log(item);
                    // console.log(item[0]); // nama produk
                    // console.log(item[1]); // No Purchase Orders
