    ...
    $('#produkId').keyup(function() {
        ...
        if(query != '')  
        {
            $.ajax({
                ...
                {
                    htmls1 = '<select class="list-unstyled form-control form-group col-sm-8" id="id_user" name="selectproduct" onchange="produkTabel(this)">';
                        // console.log(htmls1);
