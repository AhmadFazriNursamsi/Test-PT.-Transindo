...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight hetf2"><i class="bi bi-person-plus-fill"></i>
            {{ __('Customers') }} @if ($haveaccessadd) <button class="btn btn-success btn-sm" id="btn_addcustomer" onclick="addModal()"><i class="fa fa-plus"></i> Add Customers</button> 
        </h2>
        @endif
    </x-slot>
    ...
    <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="modal-body">
                ...
                <div class="container form-add"></div>
...
{{-- View Modal --}}
<div class="modal fade viewCustomer" id="viewCustomer" tabindex="-1" role="dialog" aria-labelledby="viewUserTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="row">
                <div class="container">
...
////// Show alamat
    function mainshowalamata(id){
        ...
        var form = $('#viewCustomer');
            ...
            $(".closeModalViewUser").on('click', function() {
