                ...
                <div class="p-6 bg-white border-b border-gray-200">
                   ...
                   <div class="table-responsive">
                        <table id="userstable" class="table text-start table-striped align-middle table-bordered table-hover mb-0">
                            ...
                            <tr>
                                    <td></td>
                                    <td><input type="text" class="form-control input-sm src_class_user" autocomplete="off" onkeyup="searcAjax(this)" placeholder="nama" name="name"></td>
                                    ...
                                    <td>  
                                      ...
                                      <td><input type="text" class="form-control input-sm src_class_user" autocomplete="off" onkeyup="searcAjax(this)" placeholder="mobile" name="mobile"></td>
                                      <!-- <td>
                                            <select name="gudang" id="gudang" class="form-control input-sm src_class_user" onchange="searcAjax(this, 1)">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    ...
    <div class="modal-header">
      <h6>
        ...
        </i><span id="titlegudang"></span></span>
    ...
    <div class="modal-body">
      <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          ...
          <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
              <dl class="row mb-0" id="datauser-3">Gudang : </dl>
...
<script type="text/javascript">
            ...
            columnDefs: [
                 {
                   ...
                   'render': function (data, type, full, meta){
                       return '<span class="btn btn-info btn-sm" onclick="showdetail('+full[10]+')">details</span>';
                   }
                },  
    ...
    function showdetail(idx){
      ...
      $.ajax({
          ...
          success: function (response) {
            ...
            // console.log(response.datas[0].nama  );

            var tampungGudang = "";
                         
                         $.each(response.datas, function(k, item){
                          // console.log(k, item.nama);
                            //  tampungGudang += tampungGudang + item.nama + ", ";
                              tampungGudang += '<span class="btn-sm btn btn-info ms-2"><i class="fa fa-user-md me-2"></i><span id="con"></span>'+item.nama+'</span>';
                             
                             $('#titlegudang').html(tampungGudang);
                            });
    ...
    function appendgudangOption(){
        var url = "{{ asset('/api/getgud') }}";
        $.ajax({
            url: url,
            type: "get",
            success: function (response) {
