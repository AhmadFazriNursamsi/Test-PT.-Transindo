                    ...
                    <div class="table-responsive">
                        <table id="PaketTable" class="table text-start table-striped align-middle table-bordered table-hover mb-0">
                            <thead>
                                  ...
                                  <th class="align-center">Code Package</th>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade active show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <form id="paketform" enctype="">
                                @csrf
                                <dl class="row mb-0">
                                    <dt class="col-sm-4">Name Packag</dt>
                                    <dd class="col-sm-8">: <input type="text" name="nama_paket" id="nama_paket" class="form-group nama_paket">
                                    <dt class="col-sm-4">Code Package</dt>
                                    <dd class="col-sm-8">: <input type="text" name="nama_code" id="nama_code" class="form-group nama_paket">
    ...
    @section('script')
        <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-3-typeahead/4.0.1/bootstrap3-typeahead.min.js"></script>
            <script type="text/javascript">
                /////////////////////////////////////////////   GetData Table ///////////////////////////////////////////
                var url = "{{ asset('/api/package/getdata') }}";
                    ...
                    $('#PaketTable').DataTable({
                        ...
                        columnDefs: [{
                                ...
                                'render': function(data, type, full, meta) {
                                    return '<span class="btn btn-info btn-sm" onclick="showdetail(' + full[3] + ')"><i class="bi bi-eye-fill"> View</i></span>';
                                }
                        }],
                    });
